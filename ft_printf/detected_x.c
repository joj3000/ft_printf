...
/*   Updated: 2020/01/07 15:55:27 by jerbs            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static char		*step2_if_x(char *str, char *s, int i)
{
	char *tmp;
...
static char		*step3_if_x(char *str, char *s, int i)
{
	char *tmp;
...
void			detected_x(char *str, va_list va, int i)
{
	...
	tmp = step2_if_x(str, tmp, i);
	tmp = step3_if_x(str, tmp, i);
	ft_putstr(tmp);
	free(tmp);
	return ;
}
