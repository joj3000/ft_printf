...
/*   Updated: 2020/01/07 20:43:00 by jerbs            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void		detected_oxbx(char *str, va_list va, int i, char ch)
{
	if (ch == 'x')
		detected_x(str, va, i);
	else if (ch == 'X')
...
static void		detected_csp(char *str, va_list va, int i, char ch)
{
	if (ch == 'c')
		detected_c(str, va, i);
	else if (ch == 's')
...
static int		detect_n_do(char *str, va_list va, int i)
{
	...
	if (ch == 'u')
		detected_u(str, va, i);
	else if (ch == 'c' || ch == 's' || ch == 'p')
		detected_csp(str, va, i, ch);
	else if (ch == 'x' || ch == 'X' || ch == 'o')
		detected_oxbx(str, va, i, ch);
	else if (ch == 'd')
		detected_d(str, va, i);
	else if (ch == 'i')
		detected_i(str, va, i);
